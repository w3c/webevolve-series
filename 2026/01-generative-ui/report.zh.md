...
他还提到，**W3C顾问委员会会议（[AC 2026](https://www.w3.org/zh-hans/news-events/w3c-ac/ac-2026/)）**将于**中国杭州**举办，若能在会前逐步形成相关共识，将有助于推动更深入的交流与讨论。
...
* **移动端**：应用和服务分发逐步由模型完成，传统App/小程序中的Web页面形态正迁移为**模型生成的UI**。
